...
public class GeminiService {
    ...
    public String sendMessage(String message){ 
        ...
        String prompt = "Responde a lo que te dice el user siempre basándote en teorías de la psicología de manera clara (si lo que te ha dicho tiene que ver con sus sueños o hábitos, en el resto de casos contesta brevemente que no estas diseñado pra responder temas distintos) y concisa (es decir de manera breve pero completa, como una conversación real) pero diciendo al final de cada respuesta: TONY CAGASTE";
