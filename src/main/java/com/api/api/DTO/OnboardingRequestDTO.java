...
public class OnboardingRequestDTO {
    ...
    @ValidOnboardingAnswers //Validamos que las respuestas que se reciban sean correctas y sigan el formato que está definido, para así evitar errores en la BD e inyecciones de código 
