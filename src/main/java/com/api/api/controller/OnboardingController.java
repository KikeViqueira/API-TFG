...
public class OnboardingController {
    ...
    @PostMapping("/{userId}")
    public ResponseEntity<OnboardingAnswerDTO> saveOnboardingAnswers(@PathVariable("userId") Long userId, @RequestBody @Valid OnboardingRequestDTO onboardingRequestDTO){ //Tenemos que poner @Valid para activar la validación del DTO
