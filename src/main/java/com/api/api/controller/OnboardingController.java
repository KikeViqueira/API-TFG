...
public class OnboardingController {
    ...
    @PostMapping("/{idUser}")
    public ResponseEntity<OnboardingAnswerDTO> saveOnboardingAnswers(@PathVariable("idUser") Long idUser, @RequestBody @Valid FormRequestDTO.OnboardingRequestDTO onboardingRequestDTO){ //Tenemos que poner @Valid para activar la validación del DTO
        //Llamamos a la función que se encarga de guardar las respuestas en la BD
        OnboardingAnswerDTO onboardingAnswerDTO = onboardingService.saveOnboardingAnswers(idUser, onboardingRequestDTO.getData());
    ...
    @GetMapping("/{idUser}")
    public ResponseEntity<OnboardingAnswerDTO> getOnboardingAnswers(@PathVariable("idUser") Long idUser){
        //Llamamos a la función que se encarga de obtener las respuestas del Onboarding de un user
        OnboardingAnswerDTO onboardingAnswerDTO = onboardingService.getOnboardingAnswers(idUser);
        return ResponseEntity.ok(onboardingAnswerDTO);
    }
