...
public class DailyUserFlagsController {
    ...
    @PutMapping("/{idUser}/flags/DailyFlags/{flag}")
    public ResponseEntity<FlagEntityDTO> changeDailyFlag(@PathVariable("idUser") Long idUser, @PathVariable("flag") String flag, @RequestBody Map<String, String> flagData) {
        FlagEntityDTO flagChanged = this.dailyUserFlagsService.changeFlag(idUser, flag, flagData.get("flagValue"));
